...
public class ToVehicleFieldScoreServiceImpl implements IToVehicleFieldScoreService {
    ...
    @Override
    public ToVehicleFieldScore selectByTrafficdataId(Long trafficdataId) {
        return toVehicleFieldScoreMapper.selectByTrafficdataId(trafficdataId);
    }
    ...
    @Override
    public int updateToVehicleFieldScoreByTrafficdataId(ToVehicleFieldScore toVehicleFieldScore) {
        toVehicleFieldScore.setUpdateTime(DateUtils.getNowDate());
        return toVehicleFieldScoreMapper.updateToVehicleFieldScoreByTrafficdataId(toVehicleFieldScore);
    }

    @Override
    public int deleteToVehicleFieldScoreByIds(String ids) {
        return toVehicleFieldScoreMapper.deleteToVehicleFieldScoreByIds(ids);
    }
}