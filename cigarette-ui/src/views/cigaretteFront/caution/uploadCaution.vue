  ...
  <div>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="警示效果" prop="warningEffect">

          <template>

            <div class="block">

              <el-slider v-model="form.warningEffect" show-input>
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getCaution(cautionId).then(response => {
        ...
        this.form.warningEffect = Number(this.form.warningEffect);//进行类型转换，不然滑块数据识别不了
