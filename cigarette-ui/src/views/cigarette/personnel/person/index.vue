  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="驾驶证号码" prop="suspectLicenseNumber">
        <el-input
          v-model="queryParams.suspectLicenseNumber"
      ...
      <el-form-item label="出现次数" prop="occurrenceNumber">
        <el-input
          v-model="queryParams.occurrenceNumber"
          placeholder="请输入出现次数"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="涉案数" prop="casesInvolved">
        <el-input
          v-model="queryParams.casesInvolved"
          placeholder="请输入涉案数"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['personnel:person:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['personnel:person:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['personnel:person:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['personnel:person:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listPerson, getPerson, delPerson, addPerson, updatePerson } from "@/api/cigarette/personnel/person";
