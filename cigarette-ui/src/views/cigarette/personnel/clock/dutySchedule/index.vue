  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="值班地点" prop="dutyLocation">
        <el-input
          v-model="queryParams.dutyLocation"
          placeholder="请输入值班地点"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['personnel:schedule:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['personnel:schedule:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['personnel:schedule:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['personnel:schedule:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="scheduleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="值班ID" align="center" prop="dutyId" />
      <el-table-column label="值班表名称" align="center" prop="scheduleName" />
      ...
      <el-table-column label="值班地点" align="center" prop="dutyLocation" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="50%" append-to-body style="margin-top: 100px;">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="值班地点" prop="dutyLocation">
          <el-input v-model="form.dutyLocation" placeholder="请输入值班地点" />
        </el-form-item>
...
<script>
import { listSchedule, getSchedule, delSchedule, addSchedule, updateSchedule } from "@/api/cigarette/personnel/schedule";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        scheduleName: [
          { required: true, message: "值班表名称不能为空", trigger: "blur" }
        ],
        dutyDate: [
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getSchedule(dutyId).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('cigarette/personnel/schedule/export', {
        ...this.queryParams
