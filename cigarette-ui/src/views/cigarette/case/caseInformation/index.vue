...
<div>
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="主要案由" prop="mainCharge">
        <el-input v-model="queryParams.mainCharge" placeholder="请输入主要案由" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
                  ...
                  <el-scrollbar wrap-class="scrollbar-wrapper" style="max-height: 'auto';">
                    <el-card class="user-list">
                      <el-row v-for="(behavior, index) in filteredBehaviors" :key="index" class="user-info"
                        ...
                        <el-col :span="24">
                          <span @click="selectBehavior(behavior)" class="label"
                            style="cursor:pointer;">行为ID:{{ behavior.behaviorId }}&nbsp;&nbsp;车辆编号:{{ behavior.carId }}&nbsp;&nbsp;车牌编号:{{ behavior.licensePlate }}&nbsp;&nbsp;驾驶员ID:{{ behavior.driverId }}&nbsp;&nbsp;驾驶员姓名:{{ behavior.driverName }}
                          </span>
                        </el-col>
                      </el-row>
                    </el-card>
                  ...
                  <el-scrollbar wrap-class="scrollbar-wrapper" style="max-height: 'auto';">
                    <el-card class="user-list">
                      <el-row v-for="(user1, index) in filteredUsers1" :key="index" class="user-info"
                        ...
                        <el-col :span="24">
                          <span @click="selectUser1(user1)" class="label"
                            style="cursor:pointer;">用户ID:{{ user1.id }}&nbsp;&nbsp;用户名称:{{ user1.username }}&nbsp;&nbsp;电话号码:{{ user1.phonenumber }}
                          </span>
                        </el-col>
                      </el-row>
                    </el-card>
