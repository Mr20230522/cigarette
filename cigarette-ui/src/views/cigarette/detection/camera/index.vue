  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="摄像头厂商" prop="cameraManufacturer">
        <el-input
          v-model="queryParams.cameraManufacturer"
      ...
      <el-form-item label="分辨率" prop="resolutionRatio">
        <el-input
          v-model="queryParams.resolutionRatio"
          placeholder="请输入分辨率"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="夜视能力" prop="nightVision">
        <el-input
          v-model="queryParams.nightVision"
          placeholder="请输入夜视能力"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="摄像头组号" prop="cameraGroupIndication">
        <el-input
          v-model="queryParams.cameraGroupIndication"
          placeholder="请输入摄像头组号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['camera:camera:export']"
        >导出</el-button>
      </el-col>
...
export default {
  name: "Camera",
  dicts: ['sys_normal_disable', 'tob_driving_irection'],
  data() {
    return {
      // 遮罩层
      loading: true,
