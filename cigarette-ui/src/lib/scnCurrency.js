 ...
 * @FilePath: \web-pc\src\lib\scnCurrency.js
 */
// import router from '@/router/scnIndex'
import { isString, isHtmlElement } from './scnTypes'
import ScnUtilVar from "@/config/scnUtilVar";
  ...
  return new Promise((resole, reject) => {
    if (Object.prototype.toString.call(data)==='[object Blob]') {
      ...
      reader.onload = (e) => {
        ...
        if (result.code == ScnUtilVar.code) {
          // router.push("/login")
        }
        resole(result)
      }
