 ...
 */
@RestController
@RequestMapping("/cigarette/staff")
public class TobStaffController extends BaseController
{
     ...
     * 查询工作人员列表
     */
    @PreAuthorize("@ss.hasPermi('cigarette:staff:list')")
    @GetMapping("/list")
     ...
     * 导出工作人员列表
     */
    @PreAuthorize("@ss.hasPermi('cigarette:staff:export')")
     ...
     * 获取工作人员详细信息
     */
    @PreAuthorize("@ss.hasPermi('cigarette:staff:query')")
     ...
     * 新增工作人员
     */
    @PreAuthorize("@ss.hasPermi('cigarette:staff:add')")
     ...
     * 修改工作人员
     */
    @PreAuthorize("@ss.hasPermi('cigarette:staff:edit')")
     ...
     * 删除工作人员
     */
    @PreAuthorize("@ss.hasPermi('cigarette:staff:remove')")
